...
use common\components\Qiniu\Up;
use common\components\Qiniu\DoImg;
...
//		}
	...
	private function getUploadToken($key){
        ...
        $put_policy = array(
            ...
            'insertOnly' => 1,
            'endUser'    => $this->userId,
            'fsizeLimit' => 2097152,//2M
            'mimeLimit'  => 'image/*',//只允许上传图片，;!application/*;!audio/*;!text/*
        );
